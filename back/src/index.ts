...
app.use(session({ secret: process.env.SECRETSESSION, resave: false, saveUninitialized: true, cookie: { maxAge: 6000 * 60 * 24 * 6 * 7, sameSite: 'none', httpOnly: true, secure: true } }))
